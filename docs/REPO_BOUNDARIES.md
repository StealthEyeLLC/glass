...
| `bridge/` | Local loopback HTTP/WebSocket (`glass_bridge`) + optional **F-IPC client** to collector dev TCP; resync **types**; **no** collector-owned state inside bridge | Privileged collection, WebGPU, fake live streams |
