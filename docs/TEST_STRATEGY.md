...
| `src/scene/sceneToDrawablePrimitives.test.ts` | **`sceneToDrawablePrimitives`** equals **`buildBoundedVisualGeometryPrimitives(liveVisualSpecFromScene(scene), …)`**; explicit **layout** override; replay + **live/replay** shared tag prefix |
