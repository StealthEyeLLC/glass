...
| `src/scene/boundedClaims.test.ts` | **Vertical Slice v13** — **`computeBoundedSceneClaims`**, **`resolvePrimaryClaimId`**, append/replace status, **`buildBoundedClaimReceipt`**, **`boundedClaimEvidenceUiLines`**, panel smoke |
