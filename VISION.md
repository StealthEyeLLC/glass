...
- **First-run UX (v26):** The default **bounded showcase** path leads with **what to open** (easy entry + optional dev **Load flagship demo**); **local** bridge URLs, query flags, and transport notes sit in **Advanced** / **`<details>`** — still honest that the product is **local/provisional**, not cloud-hosted.
